        ...
        <div class="block-content collapse in">
            <div class="span12">
                <form class="form-horizontal">
                    <fieldset>
                        <legend>Update Attendance Details</legend>
                ...
                <asp:GridView ID="gvAttendance" runat="server" AutoGenerateColumns="False" AllowPaging="false"
                    ...
                    <Columns>
                        ...
                        <div class="form-actions">
                            ...
                            <asp:Button ID="btnSaveAttendance" runat="server" CssClass="btn btn-info" Text="Save Attendance" ValidationGroup="Attendance"
