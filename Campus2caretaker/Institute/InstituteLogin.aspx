<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstituteLogin.aspx.cs" Inherits="Campus2caretaker.Institute.InstituteLogin" %>
  ...
  <body id="login">
    ...
    <asp:Label ID="Label2" runat="server" meta:resourcekey="Label2Resource1" class="form-signin-heading"
        ...
        <asp:TextBox ID="UserName" runat="server"
         ...
         <asp:RegularExpressionValidator ID="UserNameEmailValidation" runat="server" 
                        ControlToValidate="UserName" ErrorMessage="This e-mail address is not valid." 
                        ToolTip="Valid e-mail address is required." ValidationGroup="Login1" 
                        meta:resourcekey="UserNameRequiredResource1" ForeColor="#FF3300" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">*</asp:RegularExpressionValidator>
